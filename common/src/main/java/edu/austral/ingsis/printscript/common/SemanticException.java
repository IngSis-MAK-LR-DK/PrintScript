...
/**
 * Raised for errors that are only detectable once meaning is attached to the AST: type mismatches,
 * undeclared variables, etc. Used by both the interpreter and the static analyzer.
 */
